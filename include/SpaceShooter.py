...
def main_menu():
    ...
    while True:
        ...
        if ev.type == pygame.KEYDOWN:
            ...
            draw_text(screen, "Presiona [ENTER] para Continuar", 30, WIDTH/2, HEIGHT/3)
            draw_text(screen, "o [Q] para Salir", 30, WIDTH/2, (HEIGHT/3)+200)
            pygame.display.update()
...
class Mob(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.speedy = random.randrange(8, 25)        ## hace random la velocidad
    ...
    def update(self):
        ...
        if (self.rect.top > HEIGHT + 10) or (self.rect.left < -25) or (self.rect.right > WIDTH + 20):
            ...
            self.speedy = random.randrange(1, 8)        ## hace random la velocidad de los asteroides
...
pygame.mixer.music.set_volume(0.5)      ## sonido de fondo del juego
...
## TODO: hace que la música del juego se repita siempre. si la reproduccion es (loops=-1) no funciona.
# Error :
...
while running:
    if menu_display:
        ...
        pygame.mixer.music.play(-1)     ## hace que la música termine cuando el jugador pierda

        menu_display = False

    #1 procesos de eventos o entradas
    clock.tick(FPS)     ## hace que el bucle se ejecute a la misma velocidad
    ...
    for hit in hits:
        ...
        if random.random() > 0.9:
            ...
            all_sprites.add(pow)
            powerups.add(pow)
        newmob()        ## se genera un nuevo asteroide
